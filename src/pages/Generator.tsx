    ...
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
      <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
        <Title
          ...
          description="Upload your model and product images to create stunning UGC, short-form videos and social media posts"
        />
          ...
          <div className="w-full">
            ...
            <div className="mb-4 text-gray-300">
              ...
              <textarea
                ...
                placeholder="Decsribe how you want the model to interact with the product. E.g. 'Model holding the product and smiling', 'Model using the product and looking surprised', etc."
                className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none resize-none transition-all"
              />
            </div>
          </div>
