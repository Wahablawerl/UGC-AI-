        ...
        >
          ...
          {gen.generatedVideo && (
            <video
              ...
              loop
              playsInline
              className="absolute inset-0 w-full h-full object-cover group-hover:opacity-100 transition duration-500"
          ...
          {!gen.generatedImage && !gen.generatedVideo && (
            <div className="absolute inset-0 w-full h-full flex flex-col items-center justify-center text-black/20">
          ...
          {!forCommunity && (
            <div
              ...
              className="absolute right-3 top-3 sm:opacity-0 group-hover:opacity-100 transition flex items-center"
            >
              ...
              <div className="flex flex-col items-end w-32 text-sm">
                <ul
                  className={`text-xs ${menuOpen ? "block" : "hidden"} overflow-hidden right-0 peer-focus:block hover:block w-40 bg-black/50 backdrop-blur-sm text-white border border-gray-500/50 rounded-lg shadow-md mt-2 py-1 z-10`}
                >
                  {gen.generatedImage && (
                    <a
                      href="#"
                      ...
                      className="flex items-center w-full gap-2 px-4 py-2 hover:bg-black/10 cursor-pointer"
                    >
                  ...
                  <button
                    ...
                    className="flex items-center w-full gap-2 px-4 py-2 hover:bg-red-950/10 text-red-400 cursor-pointer"
                  >
          ...
          <div className="absolute right-3 bottom-3">
            ...
            {gen.uploadedImages && gen.uploadedImages.length > 1 && (
              <img
        ...
        <div className="p-4">
          ...
          {gen.productDescription && (
            <div className="mt-3">
              ...
              <div className="text-sm text-gray-300 bg-white/3 p-3 rounded-md wrap-break-word">
                {gen.productDescription}
              </div>
            </div>
          )}
